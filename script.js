document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        const showError = (input, message) => {
            ...
            error.style.cssText = 'color: #e74c3c; font-size: 0.85rem; margin-top: 4px; display: block;';
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                if (submitBtn) {
                    ...
                    // Simulate submission - replace with actual form submission logic
                    setTimeout(() => {
...
window.onload = function() {
    ...
    try {
        ...
        var pageLang = (htmlEl.getAttribute('lang') || 'fr').toLowerCase().split('-')[0];
        ...
        var forceLang = langMap[pageLang] || 'fr-FR';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '35490012-a417-40e2-8e8a-f36aa3cb4848',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '35490012-a417-40e2-8e8a-f36aa3cb4848';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '35490012-a417-40e2-8e8a-f36aa3cb4848';
